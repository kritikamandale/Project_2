...
def upgrade() -> None:
    ...
    op.execute("""
        ...
        CREATE POLICY dermatologist_profiles_user_isolation ON dermatologist_profiles
        USING (user_id = (SELECT app_current_user_id()))
        WITH CHECK (user_id = (SELECT app_current_user_id()));

        DROP POLICY IF EXISTS dermatologist_profiles_service_bypass ON dermatologist_profiles;
        CREATE POLICY dermatologist_profiles_service_bypass ON dermatologist_profiles
        USING ((SELECT current_setting('app.rls_bypass', true)) = 'on')
        WITH CHECK ((SELECT current_setting('app.rls_bypass', true)) = 'on');
    """)
    ...
    op.execute("""
        ...
        CREATE POLICY product_suggestions_user_isolation ON product_suggestions
        ...
        CREATE POLICY product_suggestions_service_bypass ON product_suggestions
        USING ((SELECT current_setting('app.rls_bypass', true)) = 'on')
        WITH CHECK ((SELECT current_setting('app.rls_bypass', true)) = 'on');
    """)
    ...
    op.execute("""
        ...
        CREATE POLICY skin_conditions_user_isolation ON skin_conditions
        ...
        CREATE POLICY skin_conditions_service_bypass ON skin_conditions
        USING ((SELECT current_setting('app.rls_bypass', true)) = 'on')
        WITH CHECK ((SELECT current_setting('app.rls_bypass', true)) = 'on');
    """)
    ...
    op.execute("""
        ...
        CREATE POLICY recommendation_products_user_isolation ON recommendation_products
        ...
        CREATE POLICY recommendation_products_service_bypass ON recommendation_products
        USING ((SELECT current_setting('app.rls_bypass', true)) = 'on')
        WITH CHECK ((SELECT current_setting('app.rls_bypass', true)) = 'on');
    """)
    ...
    op.execute("""
        ...
        CREATE POLICY progress_metrics_user_isolation ON progress_metrics
        ...
        CREATE POLICY progress_metrics_service_bypass ON progress_metrics
        USING ((SELECT current_setting('app.rls_bypass', true)) = 'on')
        WITH CHECK ((SELECT current_setting('app.rls_bypass', true)) = 'on');
    """)
    ...
    op.execute("""
        ...
        CREATE POLICY review_queue_assigned_isolation ON review_queue
        ...
        CREATE POLICY review_queue_service_bypass ON review_queue
        USING ((SELECT current_setting('app.rls_bypass', true)) = 'on')
        WITH CHECK ((SELECT current_setting('app.rls_bypass', true)) = 'on');
    """)
    ...
    for table in _PUBLIC_READ_TABLES:
        op.execute(f"""
            DROP POLICY IF EXISTS {table}_service_bypass ON {table};
            CREATE POLICY {table}_service_bypass ON {table} FOR ALL
            USING ((SELECT current_setting('app.rls_bypass', true)) = 'on')
            WITH CHECK ((SELECT current_setting('app.rls_bypass', true)) = 'on');
        """)
