...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("role", sa.Enum("USER", "DERMATOLOGIST", "ADMIN", name="user_role_enum", create_type=False), nullable=False, server_default="USER"),
    ...
    op.create_table(
        ...
        sa.Column("skin_tone_category", sa.Enum("I", "II", "III", "IV", "V", "VI", name="fitzpatrick_scale_enum", create_type=False)),
    ...
    op.create_table(
        ...
        sa.Column("skin_type", sa.Enum("oily", "dry", "combination", "normal", "sensitive", name="skin_type_enum", create_type=False)),
    ...
    op.create_table(
        ...
        sa.Column("condition_name", sa.Enum("acne", "dark_spots", "pigmentation", "wrinkles", "dryness", "redness", "pores", "texture", "uneven_tone", name="condition_name_enum", create_type=False), nullable=False),
        sa.Column("severity", sa.Enum("none", "mild", "moderate", "severe", name="severity_enum", create_type=False), nullable=False),
        sa.Column("affected_zone", sa.Enum("forehead", "nose", "cheeks", "chin", "under_eye", "full_face", name="affected_zone_enum", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("diet_type", sa.Enum("veg", "non_veg", "vegan", "mixed", name="diet_type_enum", create_type=False)),
        sa.Column("stress_level", sa.Integer()),
        sa.Column("exercise_frequency", sa.Enum("none", "light", "moderate", "active", name="exercise_frequency_enum", create_type=False)),
    ...
    op.create_table(
        ...
        sa.Column("water_hardness", sa.Enum("soft", "moderate", "hard", "very_hard", name="water_hardness_enum", create_type=False)),
        sa.Column("uv_index", sa.Float()),
        sa.Column("climate_zone", sa.Enum("tropical", "arid", "semi_arid", "temperate", "coastal", name="climate_zone_enum", create_type=False)),
    ...
    op.create_table(
        ...
        sa.Column("routine_frequency", sa.Enum("daily", "alternate", "weekly", "none", name="routine_frequency_enum", create_type=False)),
    ...
    op.create_table(
        "products",
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("brand", sa.Enum("nykaa", "minimalist", "dermaco", "others", name="product_brand_enum", create_type=False), nullable=False),
        sa.Column("product_name", sa.String(255), nullable=False),
        sa.Column("product_url", sa.String(1000)),
        sa.Column("price_inr", sa.Float()),
        sa.Column("category", sa.Enum("cleanser", "toner", "serum", "moisturiser", "sunscreen", "treatment", "mask", name="product_category_enum", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("priority", sa.Enum("high", "normal", "low", name="review_priority_enum", create_type=False), nullable=False, server_default="normal"),
        sa.Column("status", sa.Enum("pending", "in_review", "approved", "rejected", "escalated", name="review_status_enum", create_type=False), nullable=False, server_default="pending"),
